    ...
    <section className="container stack-page">
      <div className="panel" style={{ maxWidth: 760 }}>
        ...
        <p style={{ color: "var(--muted)", margin: "0.75rem 0 1.25rem" }}>
          Escríbenos para pedidos especiales, tallas o mayoristas. También
          puedes chatear con nuestro asistente de WhatsApp (productos, envíos y
          pagos).
        </p>
        <div className="form-grid">
          ...
          <div>
            <strong style={{ color: "var(--navy)" }}>Bot de WhatsApp</strong>
            <p>
              Escribe <em>hola</em>, <em>productos</em>, <em>envíos</em> o{" "}
              <em>asesor</em> al número de la tienda cuando el bot esté
              conectado.
            </p>
          </div>
